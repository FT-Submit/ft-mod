...
class FastText {
 protected:
  ...
  void cbow_shared(int32_t threadId, Model::State& state, real lr, const std::vector<int32_t>& line);
  void cbow_uphid(int32_t threadId, Model::State& state, real lr, const std::vector<int32_t>& line, std::vector<int32_t>& gradMap, std::vector<Vector>& gradMat);
  void cbow_uphid_fixed(int32_t threadId, Model::State& state, real lr, const std::vector<int32_t>& line, std::vector<int32_t>& gradMap, std::vector<Vector>& gradMat);
  void cbow_uphid_shared(int32_t threadId, Model::State& state, real lr, const std::vector<int32_t>& line, std::vector<int32_t>& gradMap, std::vector<Vector>& gradMat);
  void cbow_uphid_shared_fixed(int32_t threadId, Model::State& state, real lr, const std::vector<int32_t>& line, std::vector<int32_t>& gradMap, std::vector<Vector>& gradMat);
  
  void skipgram(Model::State& state, real lr, const std::vector<int32_t>& line);
  void skipgram_batched(int32_t threadId, Model::State& state, real lr, const std::vector<int32_t>& line);
  void skipgram_ns(int32_t threadId, Model::State& state, real lr, const std::vector<int32_t>& line);
  
  //void skipgram(Model::State& state, real lr, const std::vector<int32_t>& line, Vector &nHidden, Vector &nGradient);
