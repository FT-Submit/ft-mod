...
void printUsage() {
  std::cerr
      ...
      << "\n"
      << "For evaluation of Faster Training of Word Embeddings, see help for cbow or skipgram\n"
      << std::endl;
}
...
// Commented out the production of .bin file to speed up saving and save storage space
